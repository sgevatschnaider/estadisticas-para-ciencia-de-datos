...
Applied Statistics for Data Science (Engineering & Research Track)<p align="center"><img src="assets/portada%20.gif" alt="Visualización de conceptos: Geometría de Datos, Inferencia, Learning, Modelos Estructurados y Grafos" width="100%"><sub style="font-size: 14px;">🔵 <b>Geometría & MVN</b> (Mód. I) &nbsp;|&nbsp;🟢 <b>Inferencia Comp.</b> (Mód. II) &nbsp;|&nbsp;🟠 <b>Regularización & ML</b> (Mód. III)🔴 <b>Causalidad & Tiempo</b> (Mód. IV) &nbsp;|&nbsp;🟣 <b>Grafos & Complejidad</b> (Mód. V)</sub></p>📑 Tabla de ContenidosAccesos RápidosDescripciónBibliografía BaseSyllabus DetalladoInstalación y Uso🔗 Accesos RápidosAcceso directo a las unidades del repositorio con teoría (simuladores HTML) y código fuente (Notebooks).<p align="center"><a href="https://github.com/sgevatschnaider/estadisticas-para-ciencia-de-datos/tree/main/src/classroom/probabilidad"><img src="https://img.shields.io/badge/MÓDULO_I-Geometría-0366d6?style=for-the-badge"></a><a href="https://github.com/sgevatschnaider/estadisticas-para-ciencia-de-datos/tree/main/src/classroom/inferencia"><img src="https://img.shields.io/badge/MÓDULO_II-Inferencia-0366d6?style=for-the-badge"></a><a href="https://github.com/sgevatschnaider/estadisticas-para-ciencia-de-datos/tree/main/src/classroom/learning"><img src="https://img.shields.io/badge/MÓDULO_III-Learning-0366d6?style=for-the-badge"></a><a href="https://github.com/sgevatschnaider/estadisticas-para-ciencia-de-datos/tree/main/src/classroom/pgm"><img src="https://img.shields.io/badge/MÓDULO_IV-Estructurados-0366d6?style=for-the-badge"></a><a href="https://github.com/sgevatschnaider/estadisticas-para-ciencia-de-datos/tree/main/src/classroom/tiempo"><img src="https://img.shields.io/badge/MÓDULO_V-Grafos-0366d6?style=for-the-badge"></a></p><p align="center"><a href="https://sgevatschnaider.github.io/estadisticas-para-ciencia-de-datos/" target="_blank"><img alt="Live docs" src="https://img.shields.io/badge/Live%20docs-GitHub%20Pages-2b3137?style=for-the-badge&logo=github" /></a>&nbsp;<a href="https://mybinder.org/v2/gh/sgevatschnaider/estadisticas-para-ciencia-de-datos/main" target="_blank"><img alt="Live demos" src="https://img.shields.io/badge/Live%20demos-Binder-f5a250?style=for-the-badge&logo=jupyter" /></a>&nbsp;<a href="https://colab.research.google.com/github/sgevatschnaider/estadisticas-para-ciencia-de-datos/" target="_blank"><img alt="Open in Colab" src="https://img.shields.io/badge/Open%20in-Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white" /></a></p>🎯 DescripciónEste es un material docente de nivel Ingeniería diseñado para profundizar en los fundamentos estadísticos de la Ciencia de Datos. El curso trasciende la estadística descriptiva y los tests clásicos para enfocarse en la "Caja Blanca" de la IA moderna.Ejes principales:Geometría de los datos: Proyecciones, subespacios y transformaciones espectrales.Inferencia Computacional: Métodos de remuestreo, simulación y optimización.Modelos Estructurados: Grafos, causalidad y dependencias complejas.<p align="center"><img alt="Python" src="https://img.shields.io/badge/python-3.10%2B-blue"><img alt="R" src="https://img.shields.io/badge/R-4.x-276DC3"><img alt="Julia" src="https://img.shields.io/badge/Julia-1.x-9558B2"><img alt="Code style: black" src="https://img.shields.io/badge/code%20style-black-000000.svg"><img alt="License: MIT" src="https://img.shields.io/badge/License-MIT-blue.svg"></p>📚 Bibliografía BaseEl contenido se fundamenta en las siguientes obras de referencia (The Canon):[Wasserman] — All of Statistics: A Concise Course in Statistical Inference.[ESL] — The Elements of Statistical Learning (Hastie, Tibshirani & Friedman).[BDA3] — Bayesian Data Analysis (Gelman, Carlin, et al.).[Efron] — Computer Age Statistical Inference (Efron & Hastie).[Pearl] — Causality: Models, Reasoning, and Inference.[Bishop] — Pattern Recognition and Machine Learning (PRML).[Koller] — Probabilistic Graphical Models.🗺️ Syllabus DetalladoMÓDULO I — Vectores Aleatorios y Geometría de DatosEnfoque: La distribución conjunta como objeto geométrico (subespacios, elipsoides) y concentración de la medida.Geometría de $(\mu, \Sigma)$: Matriz de covarianza como operador lineal, distancia de Mahalanobis y proyecciones.Normal Multivariante (MVN): Descomposición espectral ($\Sigma = U \Lambda U^\top$) y transformación de Blanqueo (Whitening).Teoría de Concentración: Desigualdades de Chebyshev y Hoeffding para el análisis de cotas de error en ML.MÓDULO II — Inferencia Computacional y ModernaEnfoque: Superar las limitaciones clásicas mediante optimización y simulación.Máxima Verosimilitud (MLE): Optimización numérica (Gradiente/Hessiano) e Información de Fisher.Resampling: Bootstrap paramétrico y no paramétrico para estimación de incertidumbre en métricas (AUC, F1).Alta Dimensionalidad: Control de falsos descubrimientos (FDR - Benjamini–Hochberg).MÓDULO III — Aprendizaje Estadístico (Regresión Avanzada)Enfoque: El trade-off sesgo-varianza y la regularización.Geometría de OLS: Proyección ortogonal y matriz sombrero $H = X(X^\top X)^{-1}X^\top$.Regularización: Ridge (L2) y Lasso (L1) desde una perspectiva bayesiana y geométrica.Modelos Lineales Generalizados (GLM): Familia exponencial y algoritmo IRLS.MÓDULO IV — Modelos Estructurados y CausalidadEnfoque: Modelado de dependencias complejas y dinámica temporal.Probabilistic Graphical Models (PGM): DAGs, independencia condicional y d-separación.Inferencia Causal: Operador $do(\cdot)$, identificación de confounders y criterio back-door.Bayesian Inference & MCMC: Inferencia de parámetros mediante cadenas de Markov.Series Temporales: Estacionariedad y Modelos de Espacio de Estados (Filtro de Kalman).MÓDULO V — Grafos, Complejidad y DinámicaEnfoque: Geometría no euclídea y sistemas emergentes.Teoría de Grafos: Spectral Graph Theory y el Laplaciano del grafo.Algoritmos Evolutivos: Optimización no convexa y Regresión Simbólica.Autómatas Celulares: Dinámica local y emergencia global (Regla 110/30).🚀 Cómo utilizar este materialOpción A: Ejecución en la Nube (Recomendado)Para una experiencia inmediata sin configuración local:Teoría Interactiva: Explora los archivos .html en la carpeta src/classroom/ para ver simulaciones dinámicas.Práctica: Inicia los entornos de Binder o Google Colab desde los badges superiores para ejecutar los notebooks.Opción B: Instalación LocalBash# 1. Clonar el repositorio
git clone https://github.com/sgevatschnaider/estadisticas-para-ciencia-de-datos.git
cd estadisticas-para-ciencia-de-datos
...
# 4. Lanzar entorno de trabajo
jupyter lab
✅ Requisitos y Nivel EsperadoMatemática: Álgebra lineal (autovalores, proyecciones) y cálculo multivariable.Estadística: Conocimientos básicos de probabilidad y tests de hipótesis clásicos.Programación: Nivel intermedio de Python (NumPy, Pandas).🤝 ContribucionesSi deseas reportar un error o proponer una mejora en las simulaciones, por favor abre un Issue o envía un Pull Request.Desarrollado por Sergio Gevatschnaider
